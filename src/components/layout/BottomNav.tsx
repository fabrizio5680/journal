  ...
  return (
    <>
      {isListening && dictation?.interimTranscript && (
        <div className="text-on-surface-variant/50 pointer-events-none fixed bottom-[4.5rem] left-1/2 z-30 -translate-x-1/2 px-3 text-center text-[10px] tracking-wide italic md:hidden">
          <span className="bg-surface/80 rounded-full px-2 py-0.5 backdrop-blur-sm">
